all, any: 833
array: 6,31,41,54,56,58,59,68,73,122,151,157,163,186,204,238,268,289,311,349,350,380,381,463,498,556,605,766,849,896,1146,1371,1381,1526,1567,1706,2121
backtracking: 17,39,40,46,47,78,90,254,282,291,301,491,526,698,996,1088,1593,1239,1307,1681,1718,1723,1774
bfs: 79,103,116,126,127,130,133,173,199,200,207,210,212,269,279,297,301,314,317,339,399,407,444,505,515,529,542,637,662,743,752,785,787,803,863,909,919,934,958,959,971,987,1091,1110,1161,1197,1236,1254,1293,1306,1345,1368,1376,1654,1778
...
bitwise operation: 29,136,137,191,201,231,268,318,338,342,371,461,473,476,491,693,698,1284,1371,1442,1542,1593,1680,1681
...
dfs: 17,79,91,93,95,99,100,105,106,112,113,124,129,130,133,156,200,207,210,212,230,236,241,254,261,272,297,298,301,310,329,331,333,337,364,394,399,449,463,490,529,536,543,545,549,572,637,652,653,655,662,666,671,684,687,690,694,695,743,753,778,785,787,803,827,863,889,934,947,951,959,975,987,1028,1110,1161,1236,1306,1325,1339,1340,1367,1368,1372,1373,1376,1462,1522,1559,1569,1644,1676,1740,1766,1778,2049
dynamic programming: 5,10,32,39,44,45,53,55,63,64,70,72,84,91,96,97,115,120,139,152,188,198,213,221,256,264,265,276,279,300,312,322,361,375,403,410,413,416,435,446,464,473,474,486,494,516,518,542,552,562,576,583,629,634,647,673,712,727,740,746,805,813,837,871,877,879,887,920,931,935,940,956,983,1000,1027,1035,1039,1048,1066,1092,1105,1130,1140,1143,1155,1216,1235,1259,1269,1277,1278,1301,1312,1314,1335,1406,1458,1510,1547,1548,1594,1643,1696,1746,1774,1824,1879,1937,1947,1981
graph: 785,863
...
hashset: 1,41,128,187,290,381,432,653,694,721,1239,1452,1774
inorder: 99,105,230,333,426
linked list: 2,21,24,25,61,83,86,109,138,146,148,382,432,445,587,705,706,1650
logic deduction: 444 
map: 205
math:7,9,12,50,67,149,166,168,204,223,263,268,277,279,296,319,360,384,391,470,621,794,836,837,952,1041,1344,1569,1610,1627,1643,1998,2119
...
string: 5,6,65,151,157,165,214,408,418,443,722,824,833,929,1087,1520
...
- Problems:
    ...
    - 1D array: 31-Next Permutation|556-Next Greater Element III|1643-Kth Smallest Instructions(has better solution);  41-First Missing Positive; 58-Length of Last Word; 605-Can Place Flowers; 1562-Find Latest Group of Size M(hard)
        - linear search: 163-Missing Ranges;
        - linear scanL: 896-Monotonic Array
    - 2D array: 
        - tip: in-place transformation: (289)
        - eg: 289-Game of Life; 463-Island Perimeter; 766-Toeplitz Matrix; 1706-Where Will the Ball Fall
...
- problems:
    ...
    - find contiguous regions
        - eg: 130-Surrounded Regions; 200-Number of Islands | 694-Number of Distinct Islands | 1254-Number of Closed Islands | 934-Shortest Bridge (bfs + dfs); 463-Island Perimeter; 959-Regions Cut By Slashes (need pixelating); 803-Bricks Falling When Hit (hard); 827-Making A Large Island(mark by index)
    - min cost: see ## BFS
    - operation chaining:
...
- problems:
    ...
    - two sequences:
        ...
        - eg.
            ...
            - sequence matching: 44-Wildcard Matching
    ...
    - number of ways:
        ...
        - combination/permutation: 
            - tip: 分类讨论
            - 629-K Inverse Pairs Array; 634-Find the Derangement of An Array(hard); 920-Number of Music Playlists(hard)
    - subarray max/min: 
        - can also use greedy
...
Iterate over the array and update at each step the standard set for such problems: 1.current element 2.current local maximum sum (at this given point) 3.global maximum sum seen so far.
    - eg: 1402,1520,1665
- problems:
    - general: 11-Container With Most Water|42-Trapping Rain Water; 134-Gas Station; 135-Candy;
    ...
    - rearrange with k stride: 
        ...
        - eg. 358-Rearrange String k Distance Apart(hard, classic); 621-Task Scheduler; 767-Reorganize-String
...
## Hashmap
    - problems:
        ...
        - index to value:
            -eg: 498-Diagonal Traverse(diagonal indexes sum); 953-Verifying an Alien Dictionary; 1570-Dot Product of Two Sparse Vectors;
        - value to index:
...
- problems:
    ...
    - dedup: 187-Repeated DNA Sequences; 290-Word Pattern
...
- Math deduction:
    - eg. 277-Find the Celebrity; 319-Bulb Switcher; 877-Stone Game
- Bachet's conjecture:
...
- problems:
    - array: 
        - eg: 27-Remove Element; 244. Shortest Word Distance II; 360-Sort Transformed Array; 977-Squares of a Sorted Array;
