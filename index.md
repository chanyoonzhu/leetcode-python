...
dynamic programming: 5,10,39,53,70,72,91,139,198,279,303,312,322,416,435,518,746,1314
...
segment tree: 850
sliding window: 3!,76,239,1052,1234,1423,1498,1537,1574,1577
...
- tips
    - prevents int overflow:
        ...
        mid = (start + end) // 2
        ```
- Examples: 57(bisect), 278(basic), 981(strictly increasing, find lower), 315
