...
binary search:33,57,222,240,410,875,1011,1272,1283,1428,1482
...
greedy: 45,53,135,410,435,455,621,630,875,1011,1428,1482
...
- tips
    - prevents int overflow:
        ...
        mid = (start + end) // 2
        ```
- Examples: 57(bisect), 278(basic), 981(strictly increasing, find lower), 315, 410|875|1011|1283|1482(binary search + greedy)
