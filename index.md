...
dfs: 17,79,91,99,105,106,113,124,129,133,200,207,210,212,230,236,241,261,297,298,301,329,331,333,337,394,399,449,490,529,549,652,666,687,690,694,695,743,753,778,785,787,803,863,889,934,947,951,959,975,987,1028,1110,1236,1306,1340,1462,1569,1644,1676,1740,1766,1778
dynamic programming: 5,10,32,39,45,53,55,64,70,72,91,97,139,188,198,213,221,279,300,312,322,403,410,413,416,435,464,473,474,486,494,518,542,552,562,583,712,740,746,837,877,931,1000,1035,1039,1048,1140,1143,1155,1277,1312,1314,1458,1547,1548,1696,1746,1774,1824,1937
graph: 785,863
...
- classic problems:
    ...
    - 2D shortest paths: 542-01 Matrix; 1293-Shortest Path in a Grid with Obstacles Elimination (hard)
...
- Bottom up: loop using memoization (calculate those won't change first, eg.1143, 1340) - look at the transformation formula from the top-down solution to figure out what needs to be calculated first in the loop. Can use the subproblem size as the outer loop if dp(i, j) need dp(i + 1, j - 1) (eg.312，486, 1312)
- types:
    ...
    - game theory: 486-Predict the Winner
    ...
    - number of ways to combine: knapsack?
        - eg: 1155-Number of Dice Rolls With Target Sum; 279-Perfect Squares; 552-Student Attendance Record II(hard)
    - subarray max/min: 
        - can also use greedy
...
- problems:
    ...
    - game theory: 464-Can I Win; 486-Predict the Winner; 843-Guess the Word; 877-Stone Game | 1140-Stone Game II
