...
binary search:33,57,222,240,410,1272,1428
...
greedy: 45,53,135,410,435,455,621,630,1428
...
- tips
    - prevents int overflow:
        ...
        mid = (start + end) // 2
        ```
- Examples: 57(bisect), 278(basic), 981(strictly increasing, find lower), 315, 410(binary search + greedy)
