...
bfs: 79,102,103,116,117,126,127,130,133,173,199,200,207,210,212,269,279,286,297,301,314,317,339,399,407,444,505,515,529,542,637,662,743,752,785,787,803,863,909,919,934,958,959,971,987,994,1091,1110,1161,1197,1236,1254,1293,1306,1345,1368,1376,1448,1654,1730,1778
...
greedy: 11,42,45,53,55,121,134,135,253,358,410,435,455,517,621,630,678,767,774,785,843,853,871,875,877,954,962,984,995,1014,1011,1130,1167,1231,1353,1383,1402,1405,1419,1428,1482,1057,1520,1537,1546,1552,1567,1648,1665,1710,1718,1746,1775,1802,1824,1851,1870,1877,2007
...
queue:232,239,346,656,658,1057,1425,1438,1499,1696
...
SQL: 176
sort: 31,56,99,148,164,179,220,252,274,275,280,315,524,539,556,581,593,L391,611,826,973,1300,1509,1608,1610
...
string: 5,6,8,65,151,157,165,214,271,408,418,443,722,796,824,833,859,929,984,1087,1249,1520,1554
...
two pointers: 11,15,16,18,27,42,54,61,76,86,88,121,125,159,167,209,244,246,253,259,360,392,408,415,462,524,581,611,647,670,680,777,904,977,986,1055,1229,1248,1537,1574,1577,1658,1775,1861,1868,2018
...
- problems:
    ...
    - 2D shortest paths: 286-Walls and Gates; 317-Shortest Distance from All Buildings(hard); 505-The Maze II; 542-01 Matrix; 909-Snakes and Ladders(1d conversion); 994-Rotting Oranges; 1091-Shortest Path in Binary Matrix; 1284-Minimum Number of Flips to Convert Binary Matrix to Zero Matrix (hard); 1293-Shortest Path in a Grid with Obstacles Elimination (hard); 1730. Shortest Path to Get Food;
...
## Concurrency
    ...
    - eg: 1117-Building H2O; 1188. Design Bounded Blocking Queue

## Divide and Conquer
- problems:
    - find subarrays/string with conditions:
        - eg: 53-Maximum Subarray; 248-Strobogrammatic Number III; 1763-Longest Nice Substring;
...
- problems:
    ...
    - dp[i] depends on dp[j] where j in [1...i]:
        - eg. 64-Minimum Path Sum; 96-Unique Binary Search Trees; 542-01 Matrix; 221-Maximal Square|85-Maximal Rectangle(hard)|1277-Count Square Submatrices with All Ones; 446-Arithmetic Slices II - Subsequence|1027-Longest Arithmetic Subsequence;673-Number of Longest Increasing Subsequence; 854-K-Similar_Strings; 931-Minimum Falling Path Sum | 1937-Maximum Number of Points with Cost; (revisit above examples!) 940-Distinct Subsequences II|1987-Number of Unique Good Subsequences; 1105-Filling Bookcase Shelves; 1235-Maximum Profit in Job Scheduling; 1259-Handshakes That Don't Cross; 1691-Maximum Height by Stacking Cuboids;
    ...
    - two sequences:
        ...
        - eg.
            ...
            - sequence matching: 10-Regular Expression Matching; 44-Wildcard Matching; 2060-Check if an Original String Exists Given Two Encoded Strings(hard)
    ...
    - state compression:
        - bitmasking:
            ...
            - eg: 691-Stickers to Spell Word(0/n); 1947-Maximum Compatibility Score Sum(classic, m to m)|1879-Minimum XOR Sum of Two Arrays|1066-Campus Bikes II(n to m); 1125-Smallest Sufficient Team(0/1); 1931-Painting a Grid With Three Different Colors;
    - 2D m*n:
        - eg: 63-Unique Paths II; 120-Triangle; 361-Bomb Enemy; 576-Out of Boundary Paths; 931-Minimum Falling Path Sum; 1301-Number of Paths with Max Score; 1240-Tiling a Rectangle with the Fewest Squares(H+); 1594-Maximum Non Negative Product in a Matrix; 1643-Kth Smallest Instructions; 
...
- Problems:
    - directed acyclic graph(DAG): 
        - eg. 797-All Paths From Source to Target; 1376-Time Needed to Inform All Employees; 1377-Frog Position After T Seconds; 
    - detect cycle:
        - eg: 261-Graph Valid Tree; 684-Redundant Connection;
    - eg: 785-Is Graph Bipartite?;
    - minimum cost path: Dijkstra Algorithm (see "## BFS")
    - others: 1615-Maximal Network Rank; 1761-Minimum Degree of a Connected Trio in a Graph;
    - dp: 568-Maximum Vacation Days
...
- problems:
    ...
    - greedy with sort: 853-Car Fleet; 1775-Equal Sum Arrays With Minimum Number of Operations; 1537-Get the Maximum Score; 954-Array of Doubled Pairs|2007-Find Original Array From Doubled Array; 1710-Maximum Units on a Truck; 1877-Minimize Maximum Pair Sum in Array
    ...
    - minimum state change: 995-Minimum Number of K Consecutive Bit Flips; 1824-Minimum Sideway Jumps
...
- Algebra:
    ...
    - power: 50-Pow(x, n)
    - multiplication: 43-Multiply Strings
    - division:
...
- problems:
    ...
    - sorting:
        - eg: 23-Merge k Sorted Lists; 295-Find Median from Data Stream; 373-Find K Pairs with Smallest Sums|1439-Find the Kth Smallest Sum of a Matrix With Sorted Rows; 632-Smallest Range Covering Elements from K Lists; 642-Design Search Autocomplete System; 778-Swim in Rising Water; 1675-Minimize Deviation in Array
    - greedy:
...
- eg: 346-Moving Average from Data Stream; 658-Find K Closest Elements;

## Recursion
- parenthesis:
    - 224-Basic Calculator; 726-Number of Atoms; 1096-Brace Expansion II;
- eg: 415-Add Strings; 631-Design Excel Sum Formula
...
- bucket sort
    - eg. 164, 220-Contains Duplicate III; 295-Find Median from Data Stream; 
- counting sort
    - eg. 274-H-Index;
- custom sort
...
- general:
    - eg. 826-Most Profit Assigning Work
...
- problems:
    ...
    - parenthesis: 
        - eg. 20-Valid Parentheses; 32, 394-Decode String; 536-Construct Binary Tree from String; 678, 856-Score of Parentheses; 726-Number of Atoms; 772-Basic Calculator III; 921-Minimum Add to Make Parentheses Valid(basic); 1087-Brace Expansion(no stack); 1249-Minimum Remove to Make Valid Parentheses; 1541;
...
## String:
    ...
    - problems:
        ...
        - string parsing:
            8-String to Integer (atoi); 65-Valid Number; Calculator problems(see "## Stack"); 408-Valid Word Abbreviation
        - compression:
            - tip: string hashing (eg.1554)/rolling hash
            - eg. 271-Encode and Decode Strings; 443-String Compression; 796-Rotate String; 1554-Strings Differ by One Character
        - Manchester:
...
- problems:
    ...
    - 2D array:
        - eg: 1861-Rotating the Box; 2018-Check if Word Can Be Placed In Crossword
    - palindrom: 125-Valid Palindrome; 680-Valid Palindrome II; 246-Strobogrammatic Number; 647-Palindromic Substrings;
...
- Problems:
    - dfs:
        - pre-order: 95-Unique Binary Search Trees II(hard); 100-Same Tree; 104-Maximum Depth of Binary Tree; 114-Flatten Binary Tree to Linked List(recursive/iterative); 112-Path Sum; 129-Sum Root to Leaf Numbers; 156-Binary Tree Upside Down; 297-Serialize and Deserialize Binary Tree; 449. Serialize and Deserialize BST; 536-Construct Binary Tree from String; 545-Boundary of Binary Tree; 572-Subtree of Another Tree|1367-Linked List in Binary Tree; 652-Find Duplicate Subtrees; 655-Print Binary Tree; 662-Maximum Width of Binary Tree; 671-Second Minimum Node In a Binary Tree; 687-Longest Univalue Path; 863-All Nodes Distance K in Binary Tree; 865-Smallest Subtree with all the Deepest Nodes; 951-Flip Equivalent Binary Trees; 968. Binary Tree Cameras(with dp); 1008-Construct Binary Search Tree from Preorder Traversal; 1110-Delete Nodes And Return Forest; 1325-Delete Leaves With a Given Value; 1339-Maximum Product of Splitted Binary Tree; 1372-Longest ZigZag Path in a Binary Tree; 1448-Count Good Nodes in Binary Tree 2049-Count Nodes With the Highest Score; 2096-Step-By-Step Directions From a Binary Tree Node to Another;
        - in-order traversal: 
...
- eg: 211-Design Add and Search Words Data Structure(basic); 139-Word Break|140-Word Break II; 588-Design In-Memory File System|1166-Design File System; 616-Add Bold Tag in String; 642-Design Search Autocomplete System; 745-Prefix and Suffix Search(2 Tries); 2135-Count Words Obtained After Adding a Letter;
